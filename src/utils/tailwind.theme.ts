import { CustomFlowbiteTheme, FlowbitePaginationTheme } from 'flowbite-react'
import clsx from 'clsx'

export const paginateTheme: FlowbitePaginationTheme = {
  base: '',
  layout: {
    table: {
  ...
  pages: {
    ...
    previous: {
      base: `${clsx(
        'ml-0  border border-gray-300 bg-white px-2 py-2 leading-tight text-gray-500',
        'enabled:hover:bg-gray-100 enabled:hover:text-gray-700  enabled:hover:bg-gray-300',
    ...
    next: {
      base: `${clsx(
        ...
        'bg-white px-2 py-2 leading-tight text-gray-500',
        'enabled:hover:bg-gray-300 enabled:hover:text-primary'
      )}`,
      icon: 'h-3 w-3'
    },
    selector: {
      base: 'w-8 mx-1  transition duration-300 border border-gray-300 bg-white py-1 leading-tight text-gray-500 hover:bg-gray-200 hover:text-primary',
      active:
        'bg-primary text-white hover:bg-primary hover:text-white cursor-not-allowed',
...
export const customTheme: CustomFlowbiteTheme = {
  button: {
    ...
    color: {
      ...
      primary:
        'border border-transparent bg-primary text-white focus:ring-4 focus:ring-gray-300 enabled:hover:bg-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-gray-800 dark:enabled:hover:bg-gray-700',
      failure:
      ...
      info: 'border border-transparent bg-primary text-white focus:ring-4 focus:ring-gray-300 enabled:hover:bg-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-gray-800 dark:enabled:hover:bg-gray-700',
      light:
