...
import { useGetProductsByHotDealFilterQuery } from '@/services/products.service'
      ...
      <div className="centerContent">
        <main className="md:grid md:grid-cols-4 md:gap-x-4 ">
          <section className="col-span-1 h-[calc(100%-30px)] mt-[10px]">
            <h3 className="title m-0  text-md font-bold">MARQUES</h3>
            {isFetchingBrands ? (
              <span>loading...</span>
            ) : (
              <RadioGroupSelect
          ...
          <section className="col-span-3 ">
            ...
            <section className="flex md:justify-between  flex-col md:flex-row">
              <div className="flex  md:items-center space-x-2">
                <h3 className="title m-0 text-xl font-bold">Hot deals</h3>
                {countProducts && (
